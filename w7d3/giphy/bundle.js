...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchWord) {
    return $.ajax({
        method: 'GET',
...
var GiphysSearch = function (_React$Component) {
  ...
  function GiphysSearch() {
    ...
    _this.state = { searchTerm: 'yellow fish' };
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function componentDidMount() {
      this.props.fetchSearchGiphys('yellow+fish');
    }
  }, {
    key: 'handleChange',
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchSearchGiphys: function fetchSearchGiphys(searchWord) {
      return dispatch((0, _giphy_actions.fetchSearchGiphys)(searchWord));
    }
  };
};
